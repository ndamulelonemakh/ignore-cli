...
- 📥 Download ignore file templates for 38+ languages, frameworks, and tools
...
### Languages
C, C++, Go, Java, Kotlin, Python, Ruby, Rust, Swift, Dart, Haskell, Scala, Elixir, OCaml, R, Julia, Lua, Elm
