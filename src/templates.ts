...
export const templates: TemplateList = {
  languages: [
    ...
    { name: "DM", filename: "DM.gitignore", description: "DM (BYOND) language projects" },
    { name: "Fancy", filename: "Fancy.gitignore", description: "Fancy language projects" },
    { name: "Opa", filename: "Opa.gitignore", description: "Opa language projects" },
    {
      name: "Solidity-Remix",
      filename: "Solidity-Remix.gitignore",
      description: "Solidity smart contract projects (Remix)",
    },
  ],
  frameworks: [
    ...
    { name: "Qooxdoo", filename: "Qooxdoo.gitignore", description: "Qooxdoo JavaScript framework" },
    {
      ...
      description: "CFWheels ColdFusion framework",
    },
    { name: "Concrete5", filename: "Concrete5.gitignore", description: "Concrete5 CMS projects" },
    { name: "CraftCMS", filename: "CraftCMS.gitignore", description: "Craft CMS projects" },
    { name: "EPiServer", filename: "EPiServer.gitignore", description: "EPiServer/Optimizely CMS" },
    { name: "FuelPHP", filename: "FuelPHP.gitignore", description: "FuelPHP framework projects" },
    { name: "LemonStand", filename: "LemonStand.gitignore", description: "LemonStand e-commerce" },
    { name: "Lithium", filename: "Lithium.gitignore", description: "Lithium PHP framework" },
    { name: "Nanoc", filename: "Nanoc.gitignore", description: "Nanoc static site generator" },
    {
      name: "RhodesRhomobile",
      filename: "RhodesRhomobile.gitignore",
      description: "Rhodes/Rhomobile framework",
    },
    { name: "SeamGen", filename: "SeamGen.gitignore", description: "JBoss Seam Gen projects" },
    {
      name: "SymphonyCMS",
      filename: "SymphonyCMS.gitignore",
      description: "Symphony CMS projects",
    },
    { name: "Textpattern", filename: "Textpattern.gitignore", description: "Textpattern CMS" },
  ],
  tools: [
    ...
    },
    {
      ...
      description: "Adventure Game Studio projects",
    },
    {
      name: "FlaxEngine",
      filename: "FlaxEngine.gitignore",
      description: "Flax game engine projects",
    },
    { name: "IAR", filename: "IAR.gitignore", description: "IAR Embedded Workbench projects" },
    { name: "IGORPro", filename: "IGORPro.gitignore", description: "Igor Pro projects" },
    { name: "Katalon", filename: "Katalon.gitignore", description: "Katalon Studio test suites" },
    { name: "LabVIEW", filename: "LabVIEW.gitignore", description: "LabVIEW projects" },
    {
      name: "Lasal",
      filename: "Lasal.gitignore",
      description: "LASAL Sigmatek automation projects",
    },
    { name: "Mercury", filename: "Mercury.gitignore", description: "Mercury language projects" },
    {
      name: "MetaProgrammingSystem",
      filename: "MetaProgrammingSystem.gitignore",
      description: "JetBrains MPS projects",
    },
    { name: "ModelSim", filename: "ModelSim.gitignore", description: "ModelSim HDL simulator" },
    { name: "Modelica", filename: "Modelica.gitignore", description: "Modelica modeling language" },
    {
      name: "SSDT-sqlproj",
      filename: "SSDT-sqlproj.gitignore",
      description: "SQL Server Data Tools projects",
    },
    {
      name: "Scrivener",
      filename: "Scrivener.gitignore",
      description: "Scrivener writing projects",
    },
    { name: "Sdcc", filename: "Sdcc.gitignore", description: "Small Device C Compiler projects" },
    {
      name: "SolidWorks",
      filename: "SolidWorks.gitignore",
      description: "SolidWorks CAD projects",
    },
    { name: "Stella", filename: "Stella.gitignore", description: "Atari 2600 (Stella) projects" },
    { name: "TwinCAT3", filename: "TwinCAT3.gitignore", description: "Beckhoff TwinCAT3 projects" },
    { name: "VVVV", filename: "VVVV.gitignore", description: "VVVV visual programming projects" },
    {
      name: "ecu.test",
      filename: "ecu.test.gitignore",
